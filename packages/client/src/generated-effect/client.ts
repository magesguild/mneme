...
type Endpoint3_14Request = Parameters<RawClient["server.session"]["session.ledger"]>[0]
type Endpoint3_14Input = {
  ...
  readonly order?: Endpoint3_14Request["query"]["order"]
  readonly cursor?: Endpoint3_14Request["query"]["cursor"]
}
